...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_title.setGeometry(QtCore.QRect(350, 10, 150, 40))
        font = QtGui.QFont()
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(510, 20, 100, 25))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.label_plain = QtWidgets.QLabel(self.centralwidget)
        self.label_plain.setGeometry(QtCore.QRect(20, 70, 70, 20))
        self.label_plain.setObjectName("label_plain")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(100, 70, 310, 80))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.label_cipher = QtWidgets.QLabel(self.centralwidget)
        self.label_cipher.setGeometry(QtCore.QRect(20, 170, 70, 20))
        self.label_cipher.setObjectName("label_cipher")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(100, 170, 310, 80))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.label_info = QtWidgets.QLabel(self.centralwidget)
        self.label_info.setGeometry(QtCore.QRect(450, 70, 80, 20))
        self.label_info.setObjectName("label_info")
        self.txt_info = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(530, 70, 310, 80))
        self.txt_info.setObjectName("txt_info")
        self.label_sign = QtWidgets.QLabel(self.centralwidget)
        self.label_sign.setGeometry(QtCore.QRect(450, 170, 70, 20))
        self.label_sign.setObjectName("label_sign")
        self.txt_sign = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(530, 170, 310, 80))
        self.txt_sign.setObjectName("txt_sign")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(150, 270, 100, 25))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(310, 270, 100, 25))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(580, 270, 100, 25))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(740, 270, 100, 25))
